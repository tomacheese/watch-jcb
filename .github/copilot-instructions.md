...
- 目的: Notify new campaign information added to the [JCB Card campaign list
  page](https://www.jcb.co.jp/campaign/) via Discord.
...
- 概要: Notify new campaign information added to the JCB Card campaign list page
  via Discord.
- 主要言語: TypeScript
- パッケージマネージャー: pnpm
